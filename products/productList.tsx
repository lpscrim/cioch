    ...
    colors: [
      {
        id: "forest-green",
        name: "Forest Green",
        classes: "bg-[#13352c] checked:outline-text-secondary/70",
      },
      {
        id: "light-gray",
        name: "Light Gray",
        classes: "bg-[#B8B8B8] checked:outline-text-secondary/70",
      },
      {
        id: "lavender",
        name: "Lavender",
        classes: "bg-[#7282C5] checked:outline-text-secondary/70",
      },
      {
        id:"chilli-pepper",
        name: "Chilli Pepper",
        classes: "bg-[#9B2335] checked:outline-text-secondary/70",
      },
      {
        id: "flame",
        name: "Flame",
        classes: "bg-[#ED1C24] checked:outline-text-secondary/70",
      },
      {
        id: "french-navy",
        name: "French Navy",
        classes: "bg-[#1D2951] checked:outline-text-secondary/70",
      },
      {
        id: "cobalt",
        name: "Cobalt",
      ...
      },
      {
        id: "black",
        name: "Black",
        classes: "bg-[#252C26] checked:outline-text-secondary/70",
      },
      {
        id: "hi-vis-yellow",
        name: "Hi-Vis Yellow",
        classes: "bg-[#efff00] checked:outline-text-secondary/70",
      },
      {
        id: "claret",
        name: "Claret (Renaissance)",
        classes: "bg-[#7f1734] checked:outline-text-secondary/70",
      },
      {
        id: "stone",
        name: "Stone (Renaissance)",
        classes: "bg-[#C7BEB4] checked:outline-text-secondary/70",
      },
    ],
    cordura: true,
    details: [
