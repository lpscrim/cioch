...
export default function AboutLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      <div className="min-h-[80vh] mb-5 pb-15 mt-25 flex flex-col max-w-[90rem] min-w-[75vw] px-6 pt-2 sm:pt-5 sm:px-12 mx-auto bg-foreground/80 rounded-md overflow-y-auto">
        <AboutNav />
        {children}
        <h2 className="text-xl font-semibold text-text-secondary sm:text-2xl text-center mt-25 mx-auto">
