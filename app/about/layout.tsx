...
export default function AboutLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      <div className="min-h-[80vh] mb-5 pb-15 mt-25 flex flex-col md:max-w-[90vw] lg:max-w-[80vw] min-w-[80vw] px-6 pt-2 sm:px-12 mx-auto bg-foreground/80 rounded-md overflow-y-auto">
        <AboutNav />
        {children}
