...
export default function AboutLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      <div className="min-h-[80vh] mb-5 pb-15 mt-25 flex flex-col w-[90vw] md:w-[85vw] lg:w-[80vw] 2xl:w-[70vw] px-6 pt-2 sm:px-12 mx-auto bg-foreground/80 rounded-md overflow-y-auto">
        <AboutNav />
        {children}
