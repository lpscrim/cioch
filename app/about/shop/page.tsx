      ...
      <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 mx-auto flex flex-col items-center justify-start">
          ...
          <p className="mt-6 text-lg sm:text-xl leading-8 text-text-secondary">
            ...
            browse through our range of clothing and accessories under the
            shadow of the Cuillin Hills. <br />
            <br /> As well as our range of Outdoor Clothing, we also stock
            thermal and leisure clothing from Paramo, Montane, Meindl boots, as
            well as walking and climbing accessories and local books and maps.
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 mx-auto flex flex-col items-center justify-start">
          ...
          <p className="mt-4 text-lg sm:text-xl leading-8 text-text-secondary">
            Follow the A87 to Sligachan, then take the A863 to Dunvegan. <br />
            <br /> Struan is 14 miles from Sligachan.
            <br />
          </p>
        </div>
        <div className="w-full lg:w-1/2 mt-15 mb-10 sm:mb-5 lg:mb-0 mx-auto flex flex-col items-center justify-center ">
