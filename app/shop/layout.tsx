...
export default function AboutLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-black/ via-transparent to-transparent bg-fixed pointer-events-none"></div>
      <div className="min-h-[80vh] mb-5 pb-15 mt-25 flex flex-col w-[95vw] md:w-[90vw] lg:w-[85vw] xl:w-[80vw] px-6 pt-2 sm:px-12 mx-auto bg-foreground/80 rounded-md overflow-y-auto">
        <ShopNav />
        {children}
        <Link
          href="/#perfectFit"
