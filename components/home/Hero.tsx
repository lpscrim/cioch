...
export default function Hero() {
  return (
    <div id="hero" className="h-[100vh] w-[100vw] overflow-hidden">
            ...
            <button id="scrollButton" className="invisible md:visible absolute flex flex-row p-5 left-12 bottom-12 lg:left-35 z-10 text-center text-(--color-text) text-sm xl:text-base font-[500]">
