...
export default function Contact() {
  return (
    <div className="isolate bg-text px-6 py-24 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-text-secondary sm:text-5xl">Contact sales</h2>
        <p className="mt-2 text-lg/8 text-text-secondary">Aute magna irure deserunt veniam aliqua magna enim voluptate.</p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <div className="flex gap-x-4 sm:col-span-2">
            <div className="flex h-6 items-center">
              <div className="group relative inline-flex w-8 shrink-0 rounded-full bg-text-secondary/40 p-px inset-ring inset-ring-text-secondary/5 outline-offset-2 outline-accent transition-colors duration-200 ease-in-out has-checked:bg-accent has-focus-visible:outline-2">
                <span className="size-4 rounded-full bg-text shadow-xs ring-1 ring-text-secondary/5 transition-transform duration-200 ease-in-out group-has-checked:translate-x-3.5" />
                <input
            ...
            <label htmlFor="agree-to-policies" className="text-sm/6 text-text-secondary">
              By selecting this, you agree to our{' '}
              <a href="#" className="font-semibold textspace-nowrap text-accent">
                privacy policy
              </a>
              .
            </label>
