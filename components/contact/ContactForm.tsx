            ...
            <div>
              <div className="isolate bg-text px-6 py-24 sm:py-32 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl text-center">
                  <h2 className="text-4xl font-semibold tracking-tight text-balance text-text-secondary sm:text-5xl">
                    Contact sales
                  </h2>
                  ...
                  <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div className="flex gap-x-4 sm:col-span-2">
                      ...
                      <label
                        ...
                        className="text-sm/6 text-text-secondary"
                      >
                        By selecting this, you agree to our{" "}
                        <a
                          href="#"
                          className="font-semibold textspace-nowrap text-accent"
                        >
                          privacy policy
                        </a>
                        .
