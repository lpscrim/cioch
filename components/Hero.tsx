    ...
    <div id="hero" className="h-[100vh] w-[100vw] overflow-hidden">
      <div className="relative h-full w-full">
        ...
        <div>
            ...
            <button id="scrollButton" className="invisible md:visible absolute flex flex-row font-mono left-15 bottom-15 lg:left-30 z-10 text-center text-(--color-text) text-sm font-[700]">
