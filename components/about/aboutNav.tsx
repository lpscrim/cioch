    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:hidden ">
        <select
          ...
          className="col-start-1 row-start-1 w-full appearance-none rounded-md bg-accent/80 py-2 pr-8 pl-3 text-lg font-semibold text-text-secondary outline-1 -outline-offset-1 outline-text-secondary focus:outline-2 focus:-outline-offset-2 focus:outline-secondary"
          onChange={e => {
            ...
            return (
              <Link
                ...
                className={classNames(
                  ...
                  "group relative min-w-0 flex-1 overflow-hidden  text-text-secondary px-4 py-4 text-center text-sm sm:text-base font-semibold hover:backdrop-brightness-110 transition-all focus:z-10"
                )}
              >
              <span>{tab.name}</span>
                <span
